...
export const mediumTemplate = (headerMsg, bodyMsg, imgLink) => {
  return `<!DOCTYPE html>
    <html lang="en">
                                ...
                                <td style="padding: 20px 0px 30px 0px;" class="logo">
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td bgcolor="#ffffff" width="100" align="left">
                                                <a href="https://kurirbackend-dev.herokuapp.com" target="_blank">
                                                    <img alt="Logo" src="https://s3-ap-southeast-1.amazonaws.com/kurir-assets/kurir-logo.png" width="52" height="78" style="display: block; font-family: Helvetica, Arial, sans-serif; color: #666666; font-size: 16px;"
                                                        border="0">
                                                </a>
                                            </td>
                                            <td bgcolor="#ffffff" width="400" align="right" class="mobile-hide">
                                                <table border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td align="right" style="padding: 0 0 5px 0; font-size: 14px; font-family: Arial, sans-serif; color: #666666; text-decoration: none;">
                                                            <span style="color: #666666; text-decoration: none;">Kurir.id - your package & courier partner
                                                                <br>Support center page</span>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                                        ...
                                                        <td class="padding-copy">
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td>
                                                                        <a href="https://kurirbackend-dev.herokuapp.com" target="_blank">
                                                                            <img src=${imgLink} width="500" height="200" border="0" alt="Can an email really be responsive?"
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td align="center" style="font-size: 25px; font-family: Helvetica, Arial, sans-serif; color: #333333; padding-top: 30px;"
                                                        class="padding-copy">${headerMsg}</td>
                                                </tr>
                                                <tr>
                                    ...
                                    <tr>
                                        <td style="padding: 20px 0px 20px 0px;">
                                            ...
                                            <table width="500" border="0" cellspacing="0" cellpadding="0" align="center" class="responsive-table">
                                                <tr>
                                                    <td align="center" valign="middle" style="font-size: 12px; line-height: 18px; font-family: Helvetica, Arial, sans-serif; color:#666666;">
                                                        <span class="appleFooter" style="color:#666666;">Jalan Sukahaji No.126, Kota Bandung, Jawa Barat</span>
                                                        <br>
                                                        <a class="original-only" style="color: #666666; text-decoration: none;">Kurir.id</a>
                                                        <span class="original-only" style="font-family: Arial, sans-serif; font-size: 12px; color: #444444;">&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span>
                                                        <a style="color: #666666; text-decoration: none;">Support center page</a>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
