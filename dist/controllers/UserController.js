...
var UserController = function () {
  ...
  (0, _createClass3.default)(UserController, [{
    ...
    value: function () {
      ...
      function checkForgotPassVeriCode(_x15, _x16) {
        return _ref8.apply(this, arguments);
      }

      return checkForgotPassVeriCode;
    }()
  }, {
    key: 'forgotPassword',
    value: function () {
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 3:
                ...
                if (result === true) {
                  res.status(200).json(new _ResponseBuilder2.default().setMessage('verification code successfully sent to ' + email + '.').build());
                } else {
                  res.status(422).json(new _ResponseBuilder2.default().setSuccess(false).setMessage('uh oh! there is an error when sending email to ' + email).build());
                }
